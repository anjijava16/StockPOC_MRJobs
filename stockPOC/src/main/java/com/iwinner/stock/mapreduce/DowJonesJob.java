...
public class DowJonesJob extends Configured implements Tool {
	//new MR API . 
	
	public static void main(String[] args) throws Exception {
		int result = ToolRunner.run(new DowJonesJob(), args);
		System.exit(result);
	}
	...
	public int run(String[] args) throws Exception {
		...
		job.setMapperClass(DowJonesMapper.class);
		job.setReducerClass(DowJonesReducer.class);
