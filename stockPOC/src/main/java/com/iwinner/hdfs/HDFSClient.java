...
System.out.println("File :" + filename + " stored at:");
		...
		String[] hosts = blkLocations[i].getTopologyPaths();

			System.out.format("Host %d: %s %n", i, hosts[0].toString());
...
out.write(b, 0, numBytes);
		...
		if (fileSystem.exists(path))
 {
  ...
  System.out.println(path);
		...
		System.out.println("End of the mkdir");
		}catch(Exception e){
			e.printStackTrace();
		}
